<!--环境影响评价结果-->
<template>
  <el-container class="EnvAssessment" style="width: 1100px; margin:0 auto;" >
    <!--<el-header>-->
    <!--</el-header>-->
    <el-main>
      ...
      <div class="el-dialog__body">
        <div data-v-4fbf1abc="">
          ...
          <!--总值+两个按钮-->
          <div>
            <div class="el-input el-input--small is-disabled el-input-group el-input-group--prepend"
                 style="width: 200px;">
              <el-button type="text" disabled><strong>环境影响总值：</strong></el-button>
              <el-button type="text" ><strong>472.83</strong></el-button>
            </div>
            <button type="button" class="el-button el-button--warning el-button--mini is-plain"
                    style=" margin-left: 650px;" @click="goBack"><!----><i class="el-icon-back"></i><span>返回
                  </span></button>
            <button type="button" size="medium" class="el-button el-button--primary el-button--mini is-plain"
                    style=""><i class="el-icon-printer"></i><span>导出至Word</span></button>
          </div>
          <!----------->
          <!--表头+表身-->
          <el-table
            ...
            <el-table-column
              prop="name" label="影响名称" width="200" align="center">
            </el-table-column>
            <el-table-column
              prop="type" label="生态影响类型" width="300" align="center">
            </el-table-column>
            <el-table-column
              prop="quality" label="物质量" width="200" align="center">
            </el-table-column>
            <el-table-column
        ...
        <!--柱状图+图例-->
        <br>
        <div data-v-4fbf1abc="" class="el-row" style="margin-right: -10px; width: 1000px; height:300px;">
          <!--柱状图-->
          <div id="myChart" style="float:left;width:750px;height:320px;"></div>
          <!--图例-->
          <div data-v-4fbf1abc="" id="3" style="float:right;width:auto;">
