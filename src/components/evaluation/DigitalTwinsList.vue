    ...
    <el-main>
      <el-table
        ...
        <el-table-column label="操作" align="center" width="252">
          <template slot-scope="scope">
            <router-link :to="{ path: '/evaluation/evaluationDataList'}">
              <el-button type="success" icon="el-icon-document" plain>清单数据</el-button>
              <!--          @click="toCalculate"-->
            </router-link>
            <el-button  type="info" @click="handleSceneDrawer(scope.row)" icon="el-icon-edit" plain :disabled="postSceneVisible">
              编辑
            </el-button>
          </template>
        </el-table-column>
